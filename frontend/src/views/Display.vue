...
<template>
  <div class="page">
    <div ref="displayPageElement" class="display-page">
      ...
      <GameStartCutin v-if="showCutin" :key="cutinKey" @complete="handleCutinComplete" />
      <BingoOverlay v-if="showBingo" :key="bingoKey" @complete="handleBingoComplete" />
    </div>
  </div>
</template>
...
import BingoOverlay from '@/components/BingoOverlay.vue'
